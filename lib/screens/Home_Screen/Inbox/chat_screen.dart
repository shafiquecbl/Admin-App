...
import 'package:shop_app/widgets/push_notification.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  _sendMessageArea() {
    ...
    sendMessage() {
      ...
      Messages().addMessage(widget.receiverEmail, text).then((value) {
      ...
      FirebaseFirestore.instance
        ...
        sendAndRetrieveMessage(
            ...
            title: 'New Message',
            body: 'You received a new message from Instant Tasker');
      });
      setState(() {
        isWriting = false;
      });
